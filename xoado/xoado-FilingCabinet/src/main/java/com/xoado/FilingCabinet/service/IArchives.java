...
public interface IArchives {
	 ...
	 * @return 	XoadoResult
	 */
	XoadoResult Add_Appoint_Data_Image(String archiveId,MultipartFile[] attachmentpicture,HttpServletRequest request);
	/**
	 * 6：返回指定资料的图片附件
	 * @param archiveId
	 * @param request
	 ...
	 * @return 返回当前用户所有资料信息
	 */
	XoadoResult allTheInformation(String archiveid,String page,String rows,HttpServletRequest request);
	/**
	 * 
	 * @param archiveid
	 * @return 返回指定资料详情
