...
public class UArchives {
	...
	@ResponseBody
	public XoadoResult allTheInformation(@RequestParam(value="archiveid" ,required=false) String archiveid,@RequestParam(value="page" ,required=false) String page,@RequestParam(value="rows" ,required=false) String rows, HttpServletRequest request) {
